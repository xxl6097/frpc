...
- GitHub [xxl6097/frpc](https://github.com/xxl6097/frpc)
- Docker [xxl6097/frpc](https://hub.docker.com/r/xxl6097/frpc)
...
卸载
```shell
wget https://raw.githubusercontent.com/xxl6097/frpc/master/frpc_linux_uninstall.sh && chmod +x frpc_linux_uninstall.sh && ./frpc_linux_uninstall.sh
# 以下为国内镜像
wget https://github.ioiox.com/xxl6097/frpc/raw/branch/master/frpc_linux_uninstall.sh && chmod +x frpc_linux_uninstall.sh && ./frpc_linux_uninstall.sh
```
...
```shell
git clone https://github.com/xxl6097/frpc
# git clone 本仓库镜像
git clone https://github.ioiox.com/xxl6097/frpc
# 国内镜像
...
执行以下命令启动服务
```shell
docker run -d --name=frpc --restart=always -v /root/frpc/frpc.toml:/frp/frpc.toml xxl6097/frpc
```
...
- GitHub [xxl6097/frpc](https://github.com/xxl6097/frpc)
- Docker Hub [xxl6097/frpc](https://hub.docker.com/r/xxl6097/frpc)
